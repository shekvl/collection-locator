...
public class ColumnPropertiesCommandProperties implements Comparable<ColumnPropertiesCommandProperties>{
    ...
    @Override
    public int compareTo(ColumnPropertiesCommandProperties o) {
